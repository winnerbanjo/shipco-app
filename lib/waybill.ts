/**
 * Digital Waybill PDF generation — DMX branding, tracking QR, merchant & receiver details, weight.
...
export async function generateWaybillPdf(data: WaybillData): Promise<Buffer> {
  ...
  if (data.partnerName && data.partnerTrackingUrl) {
    ...
    doc.setFont("helvetica", "bold");
    doc.setFontSize(10);
    doc.setTextColor(94, 25, 20); // #5e1914
  ...
  doc.text("Generated by DMX Logistics. This is a digital waybill.", 20, pageHeight - 20);
