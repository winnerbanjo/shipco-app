  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-40 flex h-12 min-h-[3rem] items-center gap-2 rounded-none border border-[#F40009] bg-[#F40009] px-4 py-3 font-sans text-sm font-medium text-white shadow-lg transition-colors hover:bg-[#cc0008] md:bottom-8 md:right-8 md:px-5"
