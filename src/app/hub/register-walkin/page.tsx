    ...
    <div className="mx-auto max-w-md">
      ...
      <div className="mt-8 border border-zinc-100 bg-white p-8">
        ...
        <input
          type="tel"
          placeholder="Phone"
          className="mt-4 w-full rounded-none border border-zinc-200 bg-white px-4 py-3 text-zinc-900 placeholder-zinc-400 focus:border-[#e3201b] focus:outline-none focus:ring-0"
        />
        <Link
          href="/hub/dashboard"
