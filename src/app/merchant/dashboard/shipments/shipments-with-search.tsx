  ...
  return (
    <div className="space-y-4">
      <div className="flex flex-wrap items-center gap-3 rounded-none border border-zinc-200 bg-white p-4">
        <div className="flex flex-1 min-w-[200px] items-center rounded-none border border-zinc-200 bg-white focus-within:border-[#e3201b]">
          ...
          <input
            ...
            className="h-10 flex-1 border-0 bg-transparent px-3 text-sm text-zinc-900 placeholder:text-zinc-400 focus:outline-none focus:ring-0 focus:border-[#e3201b]"
          />
        </div>
        <select
          value={status}
          onChange={(e) => setStatus(e.target.value)}
          className="h-10 rounded-none border border-zinc-200 bg-white px-3 text-sm text-zinc-900 focus:border-[#e3201b] focus:outline-none focus:ring-0"
        >
