...
function statusClass(status: string): string {
  ...
  if (s.includes("assigned")) return "border-[#e3201b] bg-[#e3201b]/10 text-[#e3201b]";
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              className="mt-2 w-full border border-zinc-200 bg-white px-4 py-3 text-sm text-zinc-900 placeholder:text-zinc-400 focus:border-[#e3201b] focus:outline-none focus:ring-1 focus:ring-[#e3201b]"
            />
          </div>
          <div>
