    ...
    return (
      <main className="min-h-screen bg-white">
        ...
        <div className="mx-auto max-w-2xl px-6 py-12 text-center">
          <p className="text-lg font-medium text-zinc-900">{fetchError ?? "Order not found"}</p>
          <p className="mt-2 text-sm text-zinc-500">Check the tracking ID or try again later.</p>
        </div>
      </main>
    );
  }
