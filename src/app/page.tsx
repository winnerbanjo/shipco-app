  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-white px-6">
      <main className="w-full max-w-sm space-y-10 text-center">
        <p className="text-2xl font-bold tracking-[0.2em] text-[#F40009]">Shipco</p>
        <p className="text-sm text-zinc-500">Ship smarter. Track easier.</p>
        <div className="flex flex-col gap-4">
          <Link
            href="/auth/login"
            className="rounded-none border border-[#F40009] bg-[#F40009] px-8 py-4 text-sm font-medium text-white shadow-sm transition-all hover:-translate-y-0.5 hover:bg-[#cc0008] hover:shadow-md"
          >
            Merchant Sign In
          </Link>
          <Link
